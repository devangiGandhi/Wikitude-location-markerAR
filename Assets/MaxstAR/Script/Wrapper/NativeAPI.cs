...
namespace maxstAR
{
    internal class NativeAPI
    {
        ...
        [DllImport(MaxstARLibName)]
        public static extern bool maxst_CameraDevice_setCalibrationData(string filePath);
        ...
        [DllImport(MaxstARLibName)]
        public static extern ulong maxst_TrackedImage_getYuv420spY_U_VPtr(ulong Image_cPtr, out IntPtr y_Ptr, out IntPtr u_Ptr, out IntPtr v_Ptr);

        [DllImport(MaxstARLibName)]
        public static extern ulong maxst_TrackedImage_getYuv420_888YUVPtr(ulong Image_cPtr, out IntPtr y_Ptr, out IntPtr u_Ptr, out IntPtr v_Ptr, bool supportRG16Texture);
		#endregion
